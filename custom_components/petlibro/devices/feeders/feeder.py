...
class Feeder(Device):
    ...
    # ------------------------------------------------------------------
    # Unit helpers (from original Feeder)
    # ------------------------------------------------------------------
    ...
    def unit_type(self) -> int:
        """The device unit type from realInfo."""
    ...
    # ------------------------------------------------------------------
    # realInfo properties (common across 5+ feeders)
    # ------------------------------------------------------------------
    ...
    # ------------------------------------------------------------------
    # Work record based properties (last feed)
    # ------------------------------------------------------------------
    ...
    # ------------------------------------------------------------------
    # Manual feed quantity property + setter
    # ------------------------------------------------------------------
